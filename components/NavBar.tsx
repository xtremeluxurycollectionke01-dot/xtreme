      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            ...
            {/* Instagram Icon */}
            <a
              href="https://www.instagram.com/xtreme_luxury_collection?igsh=dW90dTRnZXhvYTdi"
              target="_blank"
              rel="noopener noreferrer"
              className="hidden md:flex items-center justify-center transition-all duration-300 hover:scale-110"
              aria-label="Follow us on Instagram"
            >
              <div className="relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-pink-500 via-purple-500 to-yellow-500 rounded-full opacity-0 group-hover:opacity-100 blur transition duration-300"></div>
          ...
          <div className="md:hidden mt-4 pb-4 border-t border-gray-900 pt-4">
            <div className="flex flex-col space-y-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 text-gray-300 hover:text-pink-500 transition-colors py-2"
                onClick={() => setIsMenuOpen(false)}
              >
