      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          ...
          return (
            ...
            >
              {/* Make the entire card clickable except for the quick add button *
              ...
              {/* Add to Cart Button - Outside Link to prevent navigation when clicking *
              <div className="px-4 sm:p-5 lg:p-6 pt-0 sm:pt-0 lg:pt-0">
                <button 
                  onClick={(e) => {
                  ...
                  className={`w-full py-2.5 sm:py-3 rounded-lg font-bold text-sm sm:text-base transition-all flex items-center justify-center gap-2 ${
                    product.stock === 0
          ...
          {products.map((product, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Add to Cart Button - Using the AddToCartButton component *
                <div className="px-4 pb-4 sm:px-5 sm:pb-5 lg:px-6 lg:pb-6 pt-0">
                  <AddToCartButton
                    ...
                    stock={product.stock}
                    price={product.price}
                    size="" // No size selection in featured products
                    color="" // No color selection in featured products
                    quantity={1}
                    className="w-full"
                  />
                </div>
...
const FeaturedProducts = () => {
  ...
  useEffect(() => {
    const fetchFeaturedProducts = async () => {
      try {
        // Fetch only featured products from dedicated endpoint
        ...
        // result.data contains the featured products (max 8)
